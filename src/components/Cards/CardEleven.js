...
class CardEleven extends React.Component {
  ...
  onClick = () => {
    ...
    if ( radios[0].checked || radios[1].checked ) {
      this.props.onRouteChange('CardTwelve');
      this.props.updateQuestion11("5cb8d878af09d60d21e68e24", this.state.selectedOption);
    } else {
    ...
    render() {
        return(
          <div className='br3 mw8 shadow-5 center'>
            <div>
                <h3 className='' >Question 11:  Select the statement that you more closely relate to.</h3>
                  <ul>
                  <li>
                    <input 
                      type="radio" 
                      ...
                      />
                    <label htmlFor="Evangelic">I have wept for the lost on occasion.</label>
                  ...
                  <li>
                    <input 
                      ...
                      onChange= { this.handleOptionChange }
                      />
                    <label className="" htmlFor="Apostolic">I like to equip others to grow and increase.</label>
                    <div className="check"><div className="inside"></div></div>
                  </li>
                </ul>
                    <div className="flex items-center justify-center pa5">
                      <a onClick={() => this.props.onRouteChange('CardTen') } href="#0" className="f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4">
