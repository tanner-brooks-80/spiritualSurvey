...
class CardTwelve extends React.Component {
  ...
  onClick = () => {
    ...
    if ( radios[0].checked || radios[1].checked ) {
      this.props.onRouteChange('CardThirteen');
      this.props.updateQuestion12("5cb8d878af09d60d21e68e24", this.state.selectedOption);
    } else {
    ...
    render() {
        return(
          <div className='br3 mw8 shadow-5 center'>
            <div>
                <h3 className='' >Question 12:  Select the statement that you more closely relate to.</h3>
                  <ul>
                  <li>
                    <input 
                      type="radio" 
                      ...
                      />
                    <label htmlFor="Pastoral">I love to listen and ask people questions.</label>
                  ...
                  <li>
                    <input 
                      ...
                      onChange= { this.handleOptionChange }
                      />
                    <label className="" htmlFor="Prophetic">I like to help people hear God for themselves.</label>
                    <div className="check"><div className="inside"></div></div>
                  </li>
                </ul>
                    <div className="flex items-center justify-center pa5">
                      <a onClick={() => this.props.onRouteChange('CardEleven') } href="#0" className="f5 no-underline black bg-animate hover-bg-black hover-white inline-flex items-center pa3 ba border-box mr4">
